...
import { Form, Spin, Card, Button, List, message, Input} from 'antd';
              ...
              {mutate => {
                    ...
                    form.validateFields((err, fieldsValue) => {
                      if (!err) {
                        if (fieldsValue.value) {
                          updateConfig.primaryKey = String('appSecret');
                ...
                return(
                  <PageHeaderWrapper title="小程序密钥">
                    ...
                    <Card bordered={false} style={{ display: visible, textAlign: 'center' }}>
                      <List
                        itemLayout="vertical"
                        size="large"
                        dataSource={listData}
